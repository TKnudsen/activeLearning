...
public class InformationDensityActiveLearning extends AbstractActiveLearningModel {
	...
	public InformationDensityActiveLearning(IClassifier<Double, NumericalFeatureVector> learningModel, AbstractActiveLearningModel baseModel) {
		super(learningModel);
		this.baseModel = baseModel;
	}

	public InformationDensityActiveLearning(IClassifier<Double, NumericalFeatureVector> learningModel, double beta, AbstractActiveLearningModel baseModel) {
		super(learningModel);
		this.beta = beta;
		this.baseModel = baseModel;
	}
